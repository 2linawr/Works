...
function bla()
{
	document.location.replace("diplom2.php");
...
<body>
<h3>Задайте вопрос и когда администратор зайдет он ответит на него</h3>
<form method="POST"> <!--указание метода POST-->
Вопрос:<br> <input type="text" name="voprosu" required ><br><br>
<input type="submit" name="send" value="Отправить вопрос">
</form>
...
$result = mysqli_query($link,"INSERT INTO vopros_clint (vopros_client) VALUES ('$voprosu')")or die( mysqli_error($link) );
